...
import { Grid, Box, Typography, Card, CardContent, Button, Popover, TableContainer, Table, TableHead, TableCell, TableRow, TableBody, Paper } from '@mui/material'
...
export default function CheckingMembersPage() {
  ...
  function makeMember(info: MemberWithCount) {
    ...
    return (
      ...
      <TableCell component="th" scope="row" style={{ padding: 15, fontFamily: 'S-CoreDream-3Light' }}>{row.nick_name}</TableCell>
        ...
        <Table aria-labelledby="tableTitle" size={'small'} stickyHeader>
          <TableHead>
            <TableRow>
              ...
              <TableCell align="right" style={{ fontFamily: 'SUIT-Regular', fontWeight: 800, width: '15%', paddingRight: '15px' }}>공대참여</TableCell>
              <TableCell align="center" style={{ fontFamily: 'SUIT-Regular', fontWeight: 800, width: '30%', paddingRight: '15px' }}>코멘트</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {
              info.map(i => makeMember(i))
            }
          </TableBody>
        </Table>
      </TableContainer>
