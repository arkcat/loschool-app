...
const raidList: RaidReward[] = [
    ...
    normal: {
      ...
      reward: [
        { step: 1, gold: 1000, item: [{ image: 시련의빛.src, count: 11 }] },
        {
          ...
          gold: 1500,
          item: [
            { image: 시련의빛.src, count: 12 },
            { image: 관조의빛무리.src, count: 1 },
          ],
        },
        {
          step: 3,
          gold: 2000,
          item: [
            { image: 시련의빛.src, count: 17 },
            { image: 관조의빛무리.src, count: 2 },
          ],
        },
      ],
      moreReward: [
        { step: 1, gold: 600, item: [{ image: 시련의빛.src, count: 11 }] },
        {
          step: 2,
          gold: 800,
          item: [
    ...
    hard: {
      ...
      reward: [
        ...
        },
        {
          ...
          gold: 3000,
          item: [
            { image: 시련의빛.src, count: 20 },
            { image: 관조의빛무리.src, count: 3 },
          ],
        },
      ],
      moreReward: [
    ...
    normal: {
      ...
      reward: [
        ...
        { step: 3, gold: 2500, item: [{ image: 노말기운.src, count: 3 }] },
        {
          ...
          gold: 3250,
          item: [
            { image: 노말기운.src, count: 1 },
            { image: 노말엘릭서.src, count: 1 },
          ],
        },
      ],
      moreReward: [
        { step: 1, gold: 700, item: [{ image: 노말기운.src, count: 2 }] },
        { step: 2, gold: 800, item: [{ image: 노말기운.src, count: 2 }] },
        { step: 3, gold: 900, item: [{ image: 노말기운.src, count: 3 }] },
        {
          step: 4,
          gold: 1100,
          item: [
    ...
    hard: {
      ...
      reward: [
        ...
        { step: 3, gold: 4000, item: [{ image: 하드기운.src, count: 3 }] },
        {
          ...
          gold: 6000,
          item: [
            { image: 하드기운.src, count: 1 },
            { image: 하드엘릭서.src, count: 1 },
          ],
        },
      ],
      moreReward: [
        { step: 1, gold: 1000, item: [{ image: 하드기운.src, count: 2 }] },
        { step: 2, gold: 1000, item: [{ image: 하드기운.src, count: 2 }] },
        { step: 3, gold: 1500, item: [{ image: 하드기운.src, count: 3 }] },
        {
          step: 4,
          gold: 2000,
          item: [
  ...
  },
  {
    ...
    normal: {
      ...
      moreReward: [
        { step: 1, gold: 400, item: [{ image: 몽환의사념.src, count: 4 }] },
        { step: 2, gold: 600, item: [{ image: 몽환의사념.src, count: 4 }] },
        { step: 3, gold: 800, item: [{ image: 몽환의사념.src, count: 5 }] },
        { step: 4, gold: 1500, item: [{ image: 몽환의사념.src, count: 7 }] },
      ],
    },
    hard: {
      totalGold: "1-3: 6000 \n4: 30 00",
      ...
      moreReward: [
        { step: 1, gold: 700, item: [{ image: 몽환의사념.src, count: 6 }] },
        { step: 2, gold: 900, item: [{ image: 몽환의사념.src, count: 6 }] },
        { step: 3, gold: 1100, item: [{ image: 몽환의사념.src, count: 7 }] },
        { step: 4, gold: 1800, item: [{ image: 몽환의사념.src, count: 10 }] },
      ],
    },
  },
  {
    ...
    normal: {
      ...
      moreReward: [
        { step: 1, gold: 900, item: [{ image: 쇠락의눈동자.src, count: 3 }] },
        { step: 2, gold: 1100, item: [{ image: 쇠락의눈동자.src, count: 3 }] },
        { step: 3, gold: 1500, item: [{ image: 쇠락의눈동자.src, count: 5 }] },
      ],
    },
    hard: {
      totalGold: "10000",
      ...
      moreReward: [
        { step: 1, gold: 1200, item: [{ image: 쇠락의눈동자.src, count: 7 }] },
        { step: 2, gold: 1400, item: [{ image: 쇠락의눈동자.src, count: 7 }] },
        { step: 3, gold: 1900, item: [{ image: 쇠락의눈동자.src, count: 8 }] },
      ],
    },
  },
  {
      ...
      reward: [
        {
          ...
          gold: 3500,
          item: [
            { image: 어둠의불.src, count: 3 },
            { image: 마력의샘물.src, count: 2 },
          ],
        },
        {
          step: 2,
          gold: 4000,
          item: [
            { image: 어둠의불.src, count: 4 },
            { image: 마력의샘물.src, count: 3 },
          ],
        },
        {
          step: 3,
          gold: 5500,
          item: [
            { image: 어둠의불.src, count: 6 },
            { image: 마력의샘물.src, count: 4 },
          ],
        },
      ],
      moreReward: [
    ...
    hard: {
      ...
      reward: [
        ...
        },
        {
          ...
          gold: 6000,
          item: [
            { image: 어둠의불.src, count: 8 },
            { image: 마력의샘물.src, count: 9 },
          ],
        },
        {
          step: 3,
          gold: 9000,
          item: [
            { image: 어둠의불.src, count: 12 },
            { image: 마력의샘물.src, count: 12 },
          ],
        },
        {
          step: 4,
      ...
      reward: [
        {
          step: 1,
          gold: 5000,
          item: [{ image: 아그리스의비늘.src, count: 3 }],
        },
        {
          step: 2,
          gold: 9500,
          item: [{ image: 아그리스의비늘.src, count: 6 }],
        },
      ],
      moreReward: [
        {
    ...
    normal: {
      ...
      reward: [
        {
          ...
          gold: 7000,
          item: [
            { image: 베히모스의비늘.src, count: 10 },
            { image: 마력의샘물.src, count: 10 },
          ],
        },
        {
          step: 2,
      ...
      moreReward: [
        ...
        },
        {
          ...
          gold: 4900,
          item: [
            { image: 베히모스의비늘.src, count: 20 },
            { image: 마력의샘물.src, count: 18 },
          ],
        },
      ],
    },
