...
const GoldImage = () => {
  return (
    <img src={GoldIcon.src} style={{ width: "20px", marginRight: "5px" }} />
  );
};
    ...
    <Box display={"flex"}>
      ...
      >
        <TableRow>
          ...
          <TableRow>
            <TableCell
              sx={{ minWidth: "120px", textAlign: "center", border: "none" }}
            >
              <Typography style={{ fontFamily: "SUIT-Regular" }}>
                노말 <GoldImage />
                {printGold(normal.totalGold)}
              </Typography>
            </TableCell>
            {!isNarrowScreen &&
              normal.reward.map((reward, index) => (
                <TableRow key={index}>
                  <TableCell sx={{ border: "none" }}>{reward.step}관</TableCell>
                  ...
                  <TableCell sx={{ minWidth: "120px", border: "none" }}>
                    ...
                    >
                      {reward.item.map((item, index) => (
                        <ImageIcon source={item.image} count={item.count} />
                      ))}
                    </Typography>
                  </TableCell>
                </TableRow>
            ...
            <TableCell
              sx={{
                ...
                width: "1px",
                padding: "1px",
                backgroundColor: raid.color,
              }}
            />

            {!isNarrowScreen &&
              normal.moreReward.map((reward, index) => (
                <TableRow key={index}>
                  <TableCell sx={{ minWidth: "120px", border: "none" }}>
                    <Typography
                      style={{
          ...
          {hard.totalGold !== "0" && (
            <TableRow>
              ...
              {!isNarrowScreen &&
                hard.moreReward.map((reward, index) => (
                  <TableRow key={index}>
                    <TableCell sx={{ minWidth: "120px", border: "none" }}>
                      <Typography
                        style={{
