    ...
    return (
        <Box>
            ...
            <Grid container
                ...
                <Grid item xs={12}>
                    {character && (
                        <Typography variant='h3' paddingBottom={3} align='center'>{character?.char_name} 수정</Typography>
                    )}
                </Grid>
                <Grid item xs={12}>
            ...
            <Box style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '15px', gap: '15px' }}>
                ...
                <Button variant='contained' onClick={() => {
                    const shouldDelete = window.confirm(`[${character?.char_name}] 정말로 삭제하시겠습니까?`)
